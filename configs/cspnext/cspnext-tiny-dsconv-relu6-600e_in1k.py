...
work_dir = "/mnt/hdd/maro_work_dir/cspnext-tiny-dsconv-relu6-600e_in1k"
...
model = dict(
    ...
    backbone=dict(deepen_factor=0.167, widen_factor=0.375, act_cfg=act_cfg, use_depthwise=True),
